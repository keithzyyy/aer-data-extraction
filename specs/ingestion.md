...
1. Crawl every paginated page in `"https://www.aer.gov.au/authors/<BUSINESS-NAME>"`, **retain document landing-page links (NOT attachment links)**. No download is peformed at this stage. Author pages to retrieve: 
    ```python
    AUTHOR_PAGES = {
